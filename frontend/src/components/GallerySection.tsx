      ...
      <div className="max-w-6xl mx-auto">
        ...
        {isLoading ? (
          ...
          <div className="text-center py-20 bg-white border border-cream-dark rounded-2xl">
            ...
            <p className="text-charcoal/40 font-inter font-medium text-lg">No artwork yet</p>
            <p className="text-charcoal/30 font-inter text-sm mt-2">Check back soon for new additions</p>
          </div>
        ) : (
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {images.map((image) => {
          ...
          {selected && (
            <div>
              ...
              <div className="px-6 py-4">
                <p className="font-inter text-cream/70 text-sm truncate">{selected.filename}</p>
              </div>
            </div>
          )}
        </DialogContent>
