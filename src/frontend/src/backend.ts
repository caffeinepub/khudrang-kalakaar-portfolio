...
export class Backend implements backendInterface {
    ...
    async updateMediaContacts(arg0: string, arg1: string, arg2: string | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateMediaContacts(arg0, arg1, to_candid_opt_n17(this._uploadFile, this._downloadFile, arg2));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_MediaContacts_n33(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _MediaContacts): MediaContacts {
...
function from_candid_opt_n32(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_MediaContacts]): MediaContacts | null {
    return value.length === 0 ? null : from_candid_MediaContacts_n33(_uploadFile, _downloadFile, value[0]);
}
