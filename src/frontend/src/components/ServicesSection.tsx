      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="font-playfair font-bold text-4xl lg:text-5xl text-white leading-tight">
            Our <em className="text-terracotta not-italic">Services</em>
          </h2>
          <p
            className="mt-4 font-inter text-white/80 max-w-2xl mx-auto leading-relaxed"
            style={
              siteContent.servicesIntroColor
                ? { color: siteContent.servicesIntroColor }
                : undefined
            }
          >
            {siteContent.servicesIntro ||
              "From intimate home murals to grand public installations, we bring artistic excellence to every project."}
          </p>
        </div>
