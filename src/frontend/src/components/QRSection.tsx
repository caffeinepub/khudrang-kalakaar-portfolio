    ...
    <section className="section-padding bg-charcoal">
      <div className="max-w-2xl mx-auto text-center">
        ...
        <p className="text-cream/70 text-base sm:text-lg leading-relaxed mb-10">
          Scan the QR code or tap the button below to follow for daily art
          updates, behind-the-scenes, and new project reveals.
        </p>
        ...
        {isLoading ? (
          ...
          <div>
            ...
            {instagramProfile && (
              <p className="text-cream/50 text-xs mt-3 break-all">
                {instagramProfile}
              </p>
            )}
          </div>
