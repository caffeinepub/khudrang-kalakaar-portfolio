    ...
    <section id="contact" className="section-padding bg-white">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-14">
          ...
          <h2
            className="font-display text-4xl sm:text-5xl font-bold text-charcoal mt-2"
            style={
              siteContent.contactHeadingColor
                ? { color: siteContent.contactHeadingColor }
                : undefined
            }
          >
            {siteContent.contactHeading || "Let's Transform Your Space"}
          </h2>
          <div className="w-16 h-1 bg-terracotta mx-auto mt-4 rounded-full" />
          <p
            className="text-charcoal/65 text-base sm:text-lg mt-4 max-w-xl mx-auto leading-relaxed"
            style={
              siteContent.contactSubtextColor
                ? { color: siteContent.contactSubtextColor }
                : undefined
            }
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            ...
            <div className="bg-cream border border-warm-border rounded-2xl p-6 hover:border-terracotta/40 hover:shadow-warm-sm transition-all">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-charcoal/50 text-xs mt-1">
                    Follow for latest work & updates
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-charcoal/70 text-sm mt-1">
                    {siteContent.location || "Rajasthan, India"}
                  </p>
                  <p className="text-charcoal/50 text-xs mt-1">
          ...
          <div className="bg-charcoal rounded-2xl p-8 flex flex-col justify-center">
            ...
            <p className="text-cream/70 text-sm sm:text-base leading-relaxed mb-8">
              Whether it's a mural, interior decoration, or a custom canvas — I
